...
parser = argparse.ArgumentParser(description='without using lstm')
...
if not args.test:
    checkpointer = ModelCheckpoint(filepath="./model/%s_bestmodel_%dgram_%dstride_%sinit_%strainable_onlyconv.hdf5"
...
print 'Testing model...'
model.load_weights('./model/%s_bestmodel_%dgram_%dstride_%sinit_%strainable_onlyconv.hdf5'
