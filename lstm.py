...
parser = argparse.ArgumentParser(description='deepsea_lstm training')
...
while True:
    ...
    if not args.test:
        checkpointer = ModelCheckpoint(filepath="./model/%s_bestmodel_%dgram_%dstride_%sinit_%strainable.hdf5"
    ...
    print 'Testing model...'
    model.load_weights('./model/%s_bestmodel_%dgram_%dstride_%sinit_%strainable.hdf5'
